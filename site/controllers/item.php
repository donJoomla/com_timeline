 ...
 */
class TimelineControllerItem extends TimelineController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Item', 'TimelineModel');
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_timeline&view=itemform&layout=edit', false));
    }
