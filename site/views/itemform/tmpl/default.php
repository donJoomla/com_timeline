...
<div class="item-edit front-end-edit">
    ...
    <form id="form-item" action="<?php echo JRoute::_('index.php?option=com_timeline&task=item.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_timeline&task=itemform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
