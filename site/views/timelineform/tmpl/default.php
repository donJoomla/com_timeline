...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-timeline').submit(function(event){
...
<div class="timeline-edit front-end-edit">
    ...
    <form id="form-timeline" action="<?php echo JRoute::_('index.php?option=com_timeline&task=timeline.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
			...
			<div class="control-group">
				<?php $canState = false; ?>
					<?php $canState = $canState = JFactory::getUser()->authorise('core.edit.state','com_timeline'); ?>				<?php if(!$canState): ?>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_timeline&task=timelineform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_timeline" />
            <input type="hidden" name="task" value="timelineform.save" />
